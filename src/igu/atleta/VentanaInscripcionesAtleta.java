...
//		contentPane.add(getScrollPane());
	...
	private JPanel getPanel() {
		if (panel == null) {
			...
			panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Elija la opción",
	...
	protected void mostrarParaIntroducir() {
		if (!radioDni.isSelected() && !radioEmail.isSelected()) {
			JOptionPane.showMessageDialog(this, "Tienes que seleccionar una opci�n");
		} else {
...
//			table.setEnabled(false);
			...
			modelo.addColumn("Fecha �ltimo cambio");
	...
	protected void cancelarInscripcion() {
		if (table.getSelectedRow() != -1) {
			...
			if (compe.getHay_politica() == 1 && compararFecha(compe.getF_canc())) { // si tiene pol�tica y no se pas� la
				...
				if (ins.getEstado().toUpperCase().equals("INSCRITO")) {
					...
					JOptionPane.showMessageDialog(this,
							"Se ha desinscrito de la competici�n. A continuaci�n, se imprimir� un justificante con la siguiente informaci�n:"
				...
				JOptionPane.showMessageDialog(this, "Error: No se puede cancelar su inscripci�n.");
			}
		} else {
