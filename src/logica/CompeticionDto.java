...
//	}
	...
	public String toString() {
		return this.nombre + " - " + this.f_comp + " - " + this.tipo + " - " + this.distancia + " - " + this.num_plazas
				+ " plazas disponibles ";
	}
	...
	public String getId_listaEspera() {
		return id_listaEspera;
	}
